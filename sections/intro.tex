...
\begin{figure}[htpb!] % Defines figure environment
	\centering % Centers your figure
	\includegraphics[width=\textwidth]{data/twitter.pdf} % Includes your figure and defines %the size
	\caption{ Average Twitter sentiment score regarding the words Ether and Ethereum per day, data source in \cite{deepblueai}. Data for the beginning of 2019 not available.} % For your caption
	\label{fig:twitter_plot} % If you want to label your figure for in-text references
\end{figure}

% Including figures
\begin{figure}[htpb!] % Defines figure environment
	\centering % Centers your figure
	\includegraphics[width=\textwidth]{data/google.pdf} % Includes your figure and defines %the size
	\caption{  Average Google trend relative popularity score regarding the words Ether and Ethereum per day, data source in \cite{deepblueai}. Data for the beginning of 2019 not available.} % For your caption
	\label{fig:google_plot} % If you want to label your figure for in-text references
\end{figure}
