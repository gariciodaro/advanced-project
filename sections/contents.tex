...
\begin{figure}[htpb!] % Defines figure environment
	...
	\includegraphics[width=0.8\textwidth]{data/cv_time.png} % Includes your figure and defines %the size
...
\begin{figure}[htpb!] % Defines figure environment
	\centering % Centers your figure
	\includegraphics[width=0.70\textwidth]{data/nn.png} % Includes your figure and defines %the size
...
\begin{figure}[htpb!] % Defines figure environment
	\centering % Centers your figure
	\includegraphics[width=0.85\textwidth]{data/trend_SES.pdf} % Includes your figure and defines %the size
...
\begin{figure}[htpb!] % Defines figure environment
	\centering % Centers your figure
	\includegraphics[width=\textwidth]{data/Residual_error_u_SES.pdf} % Includes your figure and defines %the size
